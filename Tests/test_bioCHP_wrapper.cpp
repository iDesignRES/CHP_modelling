...
//          int Mj_len, double* Q_prod, double *W_el_prod, double* C_inv, double* C_op, double* C_op_var);
//}
...
int main(int argc, char* argv[]) {
  ...
  double expected_Mj[4], expected_Q_prod, expected_W_el_prod, expected_C_inv, expected_C_op, expected_C_op_var;

  switch(test) {
    case 1:
      fuel_def[0] = "spruce_stem"; fuel_def[1] = "spruce_bark"; fuel_def[2] = "birch_stem"; fuel_def[3] = "spruce_T&B";
      fuel_count = 4;
      Yj[0] = 0.1; Yj[1] = 0.2; Yj[2] = 0.3; Yj[3] = 0.4;
      Yj_len = 4;
      YH2Oj[0] = 0.4; YH2Oj[1] = 0.5; YH2Oj[2] = 0.35; YH2Oj[3] = 0.45;
      YH2Oj_len = 4;
      W_el = 100.0;
      Qk[0] = 30.0; Qk[1] = 40.0;
      Qk_len = 2;
      Tk_in[0] = 70.0; Tk_in[1] = 50.0;
      Tk_in_len = 2;
      Tk_out[0] = 90.0; Tk_out[1] = 80.0;
      Tk_out_len = 2;

      Mj_len = 4;
      expected_Mj[0] = 2.46386; expected_Mj[1] = 4.92771; expected_Mj[2] = 7.39157; expected_Mj[3] = 9.85543;
      ...
      break;
    case 2:
      fuel_def[0] = "spruce_stem"; fuel_def[1] = "birch_stem"; fuel_def[2] = "spruce_T&B"; fuel_def[3] = "spruce_bark";
      fuel_count = 4;
      Yj[0] = 0.1; Yj[1] = 0.3; Yj[2] = 0.4; Yj[3] = 0.2;
      Yj_len = 4;
      YH2Oj[0] = 0.4; YH2Oj[1] = 0.35; YH2Oj[2] = 0.45; YH2Oj[3] = 0.5;
      YH2Oj_len = 4;
      W_el = 100.0;
      Qk[0] = 30.0; Qk[1] = 40.0;
      Qk_len = 2;
      ...
      Mj_len = 4;
      expected_Mj[0] = 2.46386; expected_Mj[1] = 7.39157; expected_Mj[2] = 9.85543; expected_Mj[3] = 4.92771;
      expected_Q_prod = 70.0;
      expected_W_el_prod = 95.906862;
      expected_C_inv = 237.27238196773598133;
      expected_C_op = 19.58327451795999963;
  ...
  if (bioCHP_plant_c(fuel_def, fuel_count, Yj, Yj_len, YH2Oj, YH2Oj_len, W_el, Qk, Qk_len, 
           Tk_in, Tk_in_len, Tk_out, Tk_out_len, Mj, Mj_len, &Q_prod, &W_el_prod, &C_inv, &C_op, &C_op_var)) {
    ...
    for (int nj = 0; nj < Mj_len; nj++) {
      ...
      if (!approxEqual(Mj[nj], expected_Mj[nj])) {
        all_passed = false;
        cout << "Mj[" << nj << "] failed: expected " << expected_Mj[nj] << ", got " << Mj[nj] << endl;
      }
    }
    ...
    if (!approxEqual(W_el_prod, expected_W_el_prod)) {
      all_passed = false;
      cout << "W_el_prod failed: expected " << expected_W_el_prod << ", got " << W_el_prod << endl;
    }
    ...
    if (!approxEqual(C_op_var, expected_C_op_var)) {
      all_passed = false;
      cout << "C_op_var failed: expected " << expected_C_op_var << ", got " << C_op_var << endl;
    }
