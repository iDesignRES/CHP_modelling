...
void raw_feedstock_characterization(flow &feed, string feed_def) {
  ...
  if (feed_def == "spruce_stem") {
    // atomic composition:
    feed.i.push_back(species("C", 0.4738, 12.01));
    feed.i.push_back(species("H", 0.064, 1.01));
    feed.i.push_back(species("O", 0.461, 16.00));
    feed.i.push_back(species("N", 0.0009, 14.01));
    feed.i.push_back(species("S", 0.0001, 32.06));
    // proximates:
    feed.k.push_back(species("VOL", 0.7243));
    feed.k.push_back(species("FC", 0.2727));
    feed.k.push_back(species("ash", 0.003));
    // properties:
    feed.P.LHV_dry = 19.9;
  } else if (feed_def == "spruce_bark") {
    // atomic composition:
    feed.i.push_back(species("C", 0.4909, 12.01));
    feed.i.push_back(species("H", 0.0606, 1.01));
    feed.i.push_back(species("O", 0.4438, 16.00));
    feed.i.push_back(species("N", 0.0045, 14.01));
    feed.i.push_back(species("S", 0.0002, 32.06));

    // proximates:
    feed.k.push_back(species("VOL", 0.7062));
    feed.k.push_back(species("FC", 0.2685));
    ...
    // atomic composition:
    feed.i.push_back(species("C", 0.5153, 12.01));
    feed.i.push_back(species("H", 0.0651, 1.01));
    feed.i.push_back(species("O", 0.415, 16.00));
    feed.i.push_back(species("N", 0.0044, 14.01));
    feed.i.push_back(species("S", 0.0002, 32.06));

    // proximates:
    feed.k.push_back(species("VOL", 0.6982));
    feed.k.push_back(species("FC", 0.2449));
    ...
    // atomic composition:
    feed.i.push_back(species("C", 0.4862, 12.01));
    feed.i.push_back(species("H", 0.0634, 1.01));
    feed.i.push_back(species("O", 0.449, 16.00));
    feed.i.push_back(species("N", 0.0009, 14.01));
    feed.i.push_back(species("S", 0.0005, 32.06));
    // proximates:
    feed.k.push_back(species("VOL", 0.8943));
    feed.k.push_back(species("FC", 0.1035));
  ...
  // SEWAGE SLUDGE:
    ...
    // atomic composition:
    feed.i.push_back(species("C", 0.3705, 12.01));
    feed.i.push_back(species("H", 0.0585, 1.01));
    feed.i.push_back(species("O", 0.3325, 16.00));
    feed.i.push_back(species("N", 0.0425, 14.01));
    feed.i.push_back(species("S", 0.012, 32.06));
    feed.i.push_back(species("P", 0.027, 30.97));
    // proximates:
    feed.k.push_back(species("DM", 0.25));
    feed.k.push_back(species("H2O", 0.75));
    ...
    // atomic composition:
    feed.i.push_back(species("C", 0.332, 12.01));
    feed.i.push_back(species("H", 0.058, 1.01));
    feed.i.push_back(species("O", 0.322, 16.00));
    feed.i.push_back(species("N", 0.038, 14.01));
    feed.i.push_back(species("S", 0.012, 32.06));
    feed.i.push_back(species("P", 0.02145, 30.97));
    feed.i.push_back(species("K", 0.0051, 39.10));
    feed.i.push_back(species("Cl", 0.0, 35.45));
    feed.i.push_back(species("Ca", 0.0065, 40.08));
    feed.i.push_back(species("Al", 0.02935, 26.98));
    feed.i.push_back(species("Fe", 0.0256, 55.84));
    feed.i.push_back(species("Mg", 0.00365, 24.31));
    feed.i.push_back(species("Mn", 0.00000025, 54.94));
    feed.i.push_back(species("Na", 0.0031, 22.99));
    feed.i.push_back(species("Si", 0.00145, 28.08));
    feed.i.push_back(species("Ti", 0.00004, 47.87));
    feed.i.push_back(species("Zn", 0.0038, 65.38));
    feed.i.push_back(species("Hg", 0.0, 200.06));
    feed.i.push_back(species("Pb", 0.0, 207.2));
    feed.i.push_back(species("Cd", 0.0, 112.4));
    feed.i.push_back(species("Cr", 0.00000001, 52.00));
    feed.i.push_back(species("Cu", 0.00145, 63.55));
    feed.i.push_back(species("Ni", 0.00095, 58.93));
    feed.i.push_back(species("As", 0.0, 74.92));
    // proximates
    ...
    // atomic composition:
    feed.i.push_back(species("C", 0.391, 12.01));
    feed.i.push_back(species("H", 0.056, 1.01));
    feed.i.push_back(species("O", 0.3325, 16.00));
    feed.i.push_back(species("N", 0.053, 14.01));
    feed.i.push_back(species("S", 0.00062, 32.06));
    feed.i.push_back(species("P", 0.0023, 30.97));
    feed.i.push_back(species("K", 0.00082, 39.10));
    feed.i.push_back(species("Cl", 0.0, 35.45));
    feed.i.push_back(species("Ca", 0.00246, 40.08));
    feed.i.push_back(species("Al", 0.00071, 26.98));
    feed.i.push_back(species("Fe", 0.00399, 55.84));
    feed.i.push_back(species("Mg", 0.00024, 24.31));
    feed.i.push_back(species("Mn", 0.00000004, 54.94));
    feed.i.push_back(species("Na", 0.00041, 22.99));
    feed.i.push_back(species("Si", 0.0023, 28.08));
    feed.i.push_back(species("Ti", 0.0, 47.87));
    feed.i.push_back(species("Zn", 0.00008, 65.38));
    feed.i.push_back(species("Hg", 0.00000005, 200.06));
    feed.i.push_back(species("Pb", 0.0, 207.2));
    feed.i.push_back(species("Cd", 0.0, 112.4));
    feed.i.push_back(species("Cr", 0.0, 52.00));
    feed.i.push_back(species("Cu", 0.00001, 63.55));
    feed.i.push_back(species("Ni", 0.0, 58.93));
    feed.i.push_back(species("As", 0.0, 74.92));
    // proximates:
    feed.k.push_back(species("DM", 0.032));
    feed.k.push_back(species("H2O", 0.968));
