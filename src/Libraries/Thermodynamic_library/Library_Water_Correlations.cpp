...
double sPSatSteam(double P) {
  // Property calculations according IAPWS Formulation 1995
  // Entropy of saturated steam [kJ/(kg K)] as a function of pressure P [bara]
  double A, B, C, D, E, f, G, H, i, j;
...
double sTWater(double T) {
  // Property calculations according IAPWS Formulation 1995
  // Entropy of water [kJ/(kg K)] as a function of temperature T [deg.C]
  double A, B, C, D, E, f, G, H, i, j, k;
...
double HTSteam(double T) {
  // Property calculations according IAPWS Formulation 1995
  // Specific enthalpy of steam [kJ/kg] as a function of temperature T [deg.C]
  double A, B, C, D, E, f, G, H, i;
...
double vTWater(double T) {
  // Property calculations according IAPWS Formulation 1995
  // Specific volume of water [m3/kg] as a function of temperature T [deg.C]
  double A, B, C, D, E;
  A = -0.0014778;
  B = 0.003805233;
  C = 372.8596342;
  D = 10271.62001;
  E = 0.048420526;
  // = A + B * (1.0 + 4.0 * ((T-C)/D)^2.0 * ((2.0)^(1/E) - 1.0)) ^ E
...
double vTSteam(double T) {
  // Property calculations according IAPWS Formulation 1995
  // Specific volume of steam [m3/kg] as a function of temperature T [deg.C]
  double A, B, C, D, E, f;
