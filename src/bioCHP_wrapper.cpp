...
bool bioCHP_plant_c(const char** fuel_def, int fuel_count, const double* Yj, int Yj_len,
                    double W_el, const double* Qk, int Qk_len, const double* Tk_in,
                    int Tk_in_len, const double* Tk_out, int Tk_out_len, double* Mj,
                    int Mj_len, double* C_inv, double* C_op) {
  ...
  bool result = bioCHP_plant(fuel_vec, Yj_vec, W_el, Qk_vec, Tk_in_vec, Tk_out_vec, Mj_vec,
                             *C_inv, *C_op);
